...
<div class="space-y-6" 
    ...
    <div>
        ...
        <p class="text-slate-400 text-xs font-medium mt-1">Konfigurasi parameter global dan informasi rekening pembayaran kontrakan.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div class="bg-slate-900 border border-dashed border-slate-800 rounded-2xl p-6 text-center space-y-3 shadow-inner relative overflow-hidden group">
            <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.03),transparent_60%)]"></div>
            
            <div class="relative z-10 space-y-1">
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-wider block">Preview Rekening Aktif</span>
            ...
            <div class="pt-4 border-t border-slate-800/60 max-w-xs mx-auto text-center relative z-10">
                <span class="text-[10px] text-slate-600 leading-normal block">
                    *Info rekening ini akan otomatis tampil di halaman tagihan dashboard penghuni sebagai tujuan transfer resmi.
                </span>
            </div>
        </div>
